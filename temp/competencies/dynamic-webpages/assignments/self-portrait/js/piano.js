...
$(function(){
    ...
    var blueVal = Math.floor(Math.random() * (256-redVal));
    var greenVal = Math.floor(Math.random() * (256-blueVal));

    var color1 = "rgb("+redVal+","+greenVal+","+blueVal+")"
    var color2 = "rgb("+redVal+","+((greenVal+191)%255)+","+((blueVal+64)%255)+")"
    var color3 = "rgb("+redVal+","+((greenVal+64)%255)+","+((blueVal+191)%255)+")"
